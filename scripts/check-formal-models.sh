...
declare -A EXPECTED_NO_SOLUTION=(
  ...
  ["tracker-wait-settlement.maude"]=5
  ["stats-fold.maude"]=3
  ["trace-lifecycle-conformance.maude"]=3
  ["action-expansion.maude"]=3
  ["effect-key.maude"]=4
  ["telemetry-cursor.maude"]=1
  ["merge-slice.maude"]=4
  ["alpha-canonicalization.maude"]=4
  ["merge-confluence.maude"]=4
  ["text-merge-compose.maude"]=4
  ["workstream.maude"]=5
  ["workstream-boundary.maude"]=15
  ...
  ["chat-fork.maude"]=2
  ["turn-witness.maude"]=2
  ["seam-crossing.maude"]=2
  ["stat-cache.maude"]=3
  ["improve-acceptance.maude"]=4
  ["improve-holdout.maude"]=3
  ["improve-precedent.maude"]=4
  ["prefix-replay.maude"]=2
  ["settle-stopping.maude"]=2
  ["contradiction-reopener.maude"]=2
  ...
  ["view-retraction.maude"]=2
  ["settled-firing-closure.maude"]=3
  ["revision-rule-correspondence.maude"]=5
  ["std-construct-authorization.maude"]=7
  ["messaging-capability-report.maude"]=4
  ["script-capability-seeding.maude"]=2
  ...
  ["flow-classification.maude"]=3
  ["vocabulary-schema.maude"]=4
  ["vocabulary-lifecycle.maude"]=8
  ["relation-validation-scope.maude"]=3
  ["manifest-completeness.maude"]=3
  ["correspondence-reuse.maude"]=3
  ["action-classification.maude"]=4
  ["store-authorization.maude"]=5
  ["ledger-query.maude"]=4
  ["norm-succession.maude"]=3
  ["norm-custody.maude"]=3
  ["record-revision.maude"]=4
  ["obligation-status.maude"]=14
  ["norm-runner.maude"]=10
  ["evidence-selection.maude"]=7
  ["norm-preservation.maude"]=12
  ["norm-reuse.maude"]=12
  ["effective-revision.maude"]=4
  ["targeted-retirement.maude"]=7
  ["requirement-inventory.maude"]=6
  ["norm-frontier-query.maude"]=6
  ["exec-dispatch.maude"]=5
  ["norm-run-preparation.maude"]=5
  ["norm-execution-recovery.maude"]=5
  ["norm-enqueue.maude"]=7
  ["norm-terminal-commit.maude"]=7
  ["norm-settlement-recovery.maude"]=7
  ["exec-provider-receipt.maude"]=8
  ["exec-controller-fence.maude"]=6
  ["exec-controller-delivery.maude"]=2
  ["exec-controller-barrier.maude"]=5
  ["exec-completion-lifetime.maude"]=3
  ["exec-provider-lifetime.maude"]=5
  ["exec-preplacement-fence.maude"]=3
  ["exec-cancel-tracking.maude"]=3
  ["exec-outcome-custody.maude"]=4
  ["exec-retry-closure.maude"]=2
  ["exec-recovery-intent.maude"]=3
  ["exec-native-owner.maude"]=5
  ["exec-native-removal.maude"]=4
  ["exec-native-authority.maude"]=3
  ["exec-native-managed.maude"]=3
  ["exec-native-control.maude"]=3
  ["exec-native-creation.maude"]=2
  ["exec-native-composed.maude"]=3
  ["exec-fence-join.maude"]=3
  ["exec-recovery-fallback.maude"]=2
  ["exec-lifetime-tracking.maude"]=4
  ["exec-deadline-fence.maude"]=3
  ["exec-host-closure.maude"]=3
  ["exec-reconciliation-wake.maude"]=3
  ["observation-projection.maude"]=4
  ["impact-projection.maude"]=3
  ["execution-policy.maude"]=5
  ["method-discovery.maude"]=4
  ["native-impact-query.maude"]=4
  ["hosted-impact-entry.maude"]=3
  ["runtime-image-binding.maude"]=3
  ["hosted-impact-route.maude"]=3
  ["impact-selection.maude"]=5
  ["norm-prepared-dispatch.maude"]=7
  ["exec-attempt-identity.maude"]=5
  ["run-start-reattach.maude"]=7
  ["store-open-layout.maude"]=3
  ["norm-publication-outbox.maude"]=12
  ["norm-run-admission.maude"]=12
  ["norm-observer.maude"]=6
  ["norm-runtime-image.maude"]=3
  ["norm-hosted-context.maude"]=3
  ["norm-hosted-profile.maude"]=2
  ["norm-hosted-process.maude"]=3
  ["norm-hosted-invocation.maude"]=2
  ["norm-native-admission.maude"]=3
  ["norm-native-driver.maude"]=2
  ["norm-native-poll.maude"]=3
  ["norm-native-worker.maude"]=4
  ["exec-lease-expiry.maude"]=3
  ...
  ["tracker-lease.maude"]=4
  ["tracker-merge.maude"]=3
  ["ledger-freshness.maude"]=5
  ["tracker-lease-merge.maude"]=2
  ["tracker-readiness.maude"]=16
  ["tracker-ordering.maude"]=5
  ["tracker-projection.maude"]=3
  ["package-contract.maude"]=16
  ["effect-dependencies.maude"]=3
  ...
  ["mcp-admission.maude"]=7
  ["model-visible-world.maude"]=5
  ["cache-prefix-append-only.maude"]=1
  ["compaction-record-once.maude"]=1
  ["compaction-epoch-lifecycle.maude"]=2
  ["harness-class.maude"]=2
  ["harness-evidence-fork.maude"]=2
  ["delegated-settings-authority.maude"]=2
  ["delegated-wire-lifecycle.maude"]=3
  ["compute-result-cache.maude"]=2
  ["compute-priority-queue.maude"]=2
  ["restorable-context.maude"]=4
  ["restore-replay.maude"]=2
  ["skills-never-grant.maude"]=2
  ["catalogue-determinism.maude"]=1
  ["provenance-completeness.maude"]=1
  ...
  ["infoflow-reader-sets.maude"]=4
  ["infoflow-redaction.maude"]=3
  ["infoflow-redact-provenance.maude"]=2
  ["infoflow-field-signature.maude"]=6
  ["infoflow-input-provenance.maude"]=3
  ["infoflow-fact-provenance.maude"]=2
  ["infoflow-output-integrity.maude"]=3
  ["infoflow-signal-carriage.maude"]=5
  ["infoflow-coord-carriage.maude"]=4
  ["infoflow-tracker-carriage.maude"]=4
  ["infoflow-composition.maude"]=9
  ["infoflow-package.maude"]=2
  ["infoflow-carriage.maude"]=2
  ["infoflow-signature.maude"]=6
  ["infoflow-staging.maude"]=2
  ["infoflow-declassifier.maude"]=5
  ["envelope-composition.maude"]=14
  ["envelope-minting.maude"]=6
  ["actsfor-unanimity.maude"]=2
  ["credential-no-eliminator.maude"]=9
  ["credential-verify-endorse.maude"]=6
  ["credential-rung-evidence.maude"]=6
  ["credential-wrap-carriage.maude"]=5
  ["credential-unwrap-confinement.maude"]=7
  ["credential-region-escape.maude"]=4
  ["credential-region-materialization.maude"]=6
  ["credential-scope-narrowing.maude"]=4
  ["agent-provider-binding.maude"]=3
  ["model-trust-admissibility.maude"]=6
  ["case-family.maude"]=4
  ["case-selector.maude"]=2
  ["discriminant-schema.maude"]=3
  ["milestone-signal.maude"]=3
  ["effect-error.maude"]=4
  ...
  ["workflow-authority-attenuation.maude"]=3
  ["workflow-runtime-marker-reresolution.maude"]=3
  ["terminal-payload-shape.maude"]=2
  ["invoke-result-typing.maude"]=3
  ["pattern-body-surface.maude"]=2
  ["action-projection-prefix.maude"]=4
  ["action-query-validity.maude"]=6
  ["parameterized-views.maude"]=6
  ["action-sink-validity.maude"]=4
  ["action-explanations.maude"]=5
  ["action-explanation-query.maude"]=3
  ["action-capture-prefix.maude"]=4
  ["action-region-prefix.maude"]=2
  ["action-region-ownership.maude"]=4
  ["action-region-journal.maude"]=4
  ["action-region-phases.maude"]=3
  ["action-region-results.maude"]=6
  ["action-return-paths.maude"]=7
  ["action-hygiene.maude"]=3
  ["action-capture.maude"]=3
  ["action-demand.maude"]=3
  ["action-progression.maude"]=2
  ["action-root-capture.maude"]=2
  ["action-timer.maude"]=3
  ["action-caller-types.maude"]=2
  ["action-effect-grants.maude"]=4
  ["action-agent-authority.maude"]=3
  ["action-field-presence.maude"]=5
  ["action-record-payloads.maude"]=4
  ["action-record-admission.maude"]=3
  ["action-fact-subjects.maude"]=3
  ["action-subject-contracts.maude"]=4
  ["action-fact-flow.maude"]=4
  ["recorded-execution.maude"]=4
  ["action-value-types.maude"]=7
  ["action-call-graph.maude"]=2
  ["action-scopes.maude"]=9
  ["coerce-operation-value.maude"]=3
  ["action-plan-artifact.maude"]=3
  ["action-continuation-recovery.maude"]=7
  ["lexical-failure-handler.maude"]=13
  ["action-tell-values.maude"]=7
  ["action-case-types.maude"]=5
  ["action-source-sites.maude"]=3
  ["action-effect-contracts.maude"]=5
  ["action-provider-egress.maude"]=5
  ["action-executor-influence.maude"]=6
  ["action-resource-identity.maude"]=5
  ["action-effect-payload.maude"]=4
  ["action-indexed-values.maude"]=4
  ["action-null-refinement.maude"]=5
  ["action-case-patterns.maude"]=4
  ["action-rule-roots.maude"]=4
  ["action-program-analysis.maude"]=5
  ["action-table-elaboration.maude"]=6
  ["composition-body-context.maude"]=4
  ["managed-fact-provenance.maude"]=3
  ["managed-claim-endorsement.maude"]=4
  ["managed-input-selectors.maude"]=3
  ["managed-field-clearance.maude"]=2
  ["managed-rule-dependencies.maude"]=2
  ["serialized-log-append.maude"]=2
  ["managed-authority-ceilings.maude"]=3
  ["managed-source-flows.maude"]=4
  ["action-value-flow.maude"]=7
  ["action-workflow-terminals.maude"]=8
  ["executable-program.maude"]=6
  ["typed-executable-program.maude"]=7
  ["coerce-settlement.maude"]=3
)
...
declare -A EXPECTED_SOLUTION=(
  ...
  ["tracker-wait-settlement.maude"]=8
  ["stats-fold.maude"]=6
  ["trace-lifecycle-conformance.maude"]=10
  ["action-expansion.maude"]=2
  ["effect-key.maude"]=4
  ["telemetry-cursor.maude"]=5
  ["merge-slice.maude"]=6
  ["alpha-canonicalization.maude"]=8
  ...
  ["chat-fork.maude"]=5
  ["turn-witness.maude"]=4
  ["seam-crossing.maude"]=4
  ["stat-cache.maude"]=5
  ["improve-acceptance.maude"]=4
  ["improve-holdout.maude"]=5
  ["improve-precedent.maude"]=3
  ["prefix-replay.maude"]=3
  ["settle-stopping.maude"]=3
  ["contradiction-reopener.maude"]=3
  ...
  ["view-retraction.maude"]=4
  ["settled-firing-closure.maude"]=4
  ["revision-rule-correspondence.maude"]=7
  ["std-construct-authorization.maude"]=5
  ["messaging-capability-report.maude"]=4
  ["script-capability-seeding.maude"]=1
  ...
  ["construct-grammar.maude"]=15
  ["construct-interop-examples.maude"]=7
  ["lowering-class-lifecycle.maude"]=11
  ["construct-lowering.maude"]=12
  ["lowering-runtime-handoff.maude"]=5
  ["tracker-claim-turn.maude"]=2
  ["flow-classification.maude"]=5
  ["vocabulary-schema.maude"]=6
  ["vocabulary-lifecycle.maude"]=16
  ["relation-validation-scope.maude"]=7
  ["manifest-completeness.maude"]=8
  ["correspondence-reuse.maude"]=6
  ["action-classification.maude"]=11
  ["store-authorization.maude"]=8
  ["ledger-query.maude"]=6
  ["norm-succession.maude"]=6
  ["norm-custody.maude"]=6
  ["record-revision.maude"]=7
  ["obligation-status.maude"]=19
  ["norm-runner.maude"]=18
  ["evidence-selection.maude"]=10
  ["norm-preservation.maude"]=14
  ["norm-reuse.maude"]=15
  ["effective-revision.maude"]=10
  ["targeted-retirement.maude"]=11
  ["requirement-inventory.maude"]=12
  ["norm-frontier-query.maude"]=8
  ["exec-dispatch.maude"]=9
  ["norm-run-preparation.maude"]=8
  ["norm-execution-recovery.maude"]=8
  ["norm-enqueue.maude"]=13
  ["norm-terminal-commit.maude"]=15
  ["norm-settlement-recovery.maude"]=13
  ["exec-provider-receipt.maude"]=16
  ["exec-controller-fence.maude"]=13
  ["exec-controller-delivery.maude"]=5
  ["exec-controller-barrier.maude"]=7
  ["exec-completion-lifetime.maude"]=5
  ["exec-provider-lifetime.maude"]=7
  ["exec-preplacement-fence.maude"]=5
  ["exec-cancel-tracking.maude"]=5
  ["exec-outcome-custody.maude"]=6
  ["exec-retry-closure.maude"]=4
  ["exec-recovery-intent.maude"]=4
  ["exec-native-owner.maude"]=8
  ["exec-native-removal.maude"]=6
  ["exec-native-authority.maude"]=5
  ["exec-native-managed.maude"]=5
  ["exec-native-control.maude"]=5
  ["exec-native-creation.maude"]=4
  ["exec-native-composed.maude"]=5
  ["exec-fence-join.maude"]=6
  ["exec-recovery-fallback.maude"]=4
  ["exec-lifetime-tracking.maude"]=6
  ["exec-deadline-fence.maude"]=5
  ["exec-host-closure.maude"]=5
  ["exec-reconciliation-wake.maude"]=7
  ["observation-projection.maude"]=7
  ["impact-projection.maude"]=8
  ["execution-policy.maude"]=6
  ["method-discovery.maude"]=5
  ["native-impact-query.maude"]=5
  ["hosted-impact-entry.maude"]=4
  ["runtime-image-binding.maude"]=4
  ["hosted-impact-route.maude"]=4
  ["impact-selection.maude"]=13
  ["norm-prepared-dispatch.maude"]=8
  ["exec-attempt-identity.maude"]=10
  ["run-start-reattach.maude"]=9
  ["store-open-layout.maude"]=7
  ["norm-publication-outbox.maude"]=20
  ["norm-run-admission.maude"]=16
  ["norm-observer.maude"]=10
  ["norm-runtime-image.maude"]=5
  ["norm-hosted-context.maude"]=5
  ["norm-hosted-profile.maude"]=4
  ["norm-hosted-process.maude"]=4
  ["norm-hosted-invocation.maude"]=3
  ["norm-native-admission.maude"]=5
  ["norm-native-driver.maude"]=3
  ["norm-native-poll.maude"]=5
  ["norm-native-worker.maude"]=9
  ["exec-lease-expiry.maude"]=6
  ...
  ["tracker-lease.maude"]=5
  ["tracker-merge.maude"]=6
  ["ledger-freshness.maude"]=7
  ["tracker-lease-merge.maude"]=4
  ["tracker-readiness.maude"]=11
  ["tracker-ordering.maude"]=8
  ["tracker-projection.maude"]=2
  ["package-contract.maude"]=10
  ["effect-dependencies.maude"]=5
  ["guard-commit-bite.maude"]=2
  ...
  ["owned-harness-resume.maude"]=1
  ["mcp-admission.maude"]=7
  ["model-visible-world.maude"]=11
  ["cache-prefix-append-only.maude"]=3
  ["compaction-record-once.maude"]=2
  ["compaction-epoch-lifecycle.maude"]=3
  ["harness-class.maude"]=2
  ["harness-evidence-fork.maude"]=2
  ["delegated-settings-authority.maude"]=2
  ["delegated-wire-lifecycle.maude"]=3
  ["compute-result-cache.maude"]=3
  ["compute-priority-queue.maude"]=3
  ["restorable-context.maude"]=3
  ["restore-replay.maude"]=2
  ["skills-never-grant.maude"]=2
  ["catalogue-determinism.maude"]=2
  ["provenance-completeness.maude"]=2
  ...
  ["infoflow-confidentiality.maude"]=4
  ["infoflow-reader-sets.maude"]=4
  ["infoflow-redaction.maude"]=2
  ["infoflow-redact-provenance.maude"]=2
  ["infoflow-field-signature.maude"]=6
  ["infoflow-input-provenance.maude"]=3
  ["infoflow-fact-provenance.maude"]=4
  ["infoflow-output-integrity.maude"]=3
  ["infoflow-signal-carriage.maude"]=4
  ["infoflow-coord-carriage.maude"]=4
  ["infoflow-tracker-carriage.maude"]=5
  ["infoflow-composition.maude"]=9
  ["infoflow-package.maude"]=3
  ["infoflow-carriage.maude"]=2
  ["infoflow-signature.maude"]=3
  ["infoflow-staging.maude"]=2
  ["infoflow-declassifier.maude"]=3
  ["envelope-composition.maude"]=18
  ["envelope-minting.maude"]=8
  ["actsfor-unanimity.maude"]=3
  ["credential-no-eliminator.maude"]=8
  ["credential-verify-endorse.maude"]=4
  ["credential-rung-evidence.maude"]=5
  ["credential-wrap-carriage.maude"]=4
  ["credential-unwrap-confinement.maude"]=6
  ["credential-region-escape.maude"]=5
  ["credential-region-materialization.maude"]=5
  ["credential-scope-narrowing.maude"]=5
  ["agent-provider-binding.maude"]=5
  ["model-trust-admissibility.maude"]=5
  ["case-family.maude"]=5
  ["case-selector.maude"]=1
  ["discriminant-schema.maude"]=5
  ["milestone-signal.maude"]=2
  ["effect-error.maude"]=5
  ...
  ["invoke-result-typing.maude"]=7
  ["pattern-body-surface.maude"]=6
  ["action-projection-prefix.maude"]=10
  ["action-query-validity.maude"]=12
  ["parameterized-views.maude"]=12
  ["action-sink-validity.maude"]=8
  ["action-explanations.maude"]=13
  ["action-explanation-query.maude"]=12
  ["action-capture-prefix.maude"]=8
  ["action-region-prefix.maude"]=10
  ["action-region-ownership.maude"]=7
  ["action-region-journal.maude"]=11
  ["action-region-phases.maude"]=12
  ["action-region-results.maude"]=15
  ["action-return-paths.maude"]=5
  ["action-hygiene.maude"]=7
  ["action-capture.maude"]=8
  ["action-demand.maude"]=8
  ["action-progression.maude"]=5
  ["action-root-capture.maude"]=4
  ["action-timer.maude"]=5
  ["action-caller-types.maude"]=4
  ["action-effect-grants.maude"]=7
  ["action-agent-authority.maude"]=5
  ["action-field-presence.maude"]=4
  ["action-record-payloads.maude"]=6
  ["action-record-admission.maude"]=6
  ["action-fact-subjects.maude"]=5
  ["action-subject-contracts.maude"]=5
  ["action-fact-flow.maude"]=6
  ["recorded-execution.maude"]=6
  ["action-value-types.maude"]=6
  ["action-call-graph.maude"]=5
  ["action-scopes.maude"]=13
  ["coerce-operation-value.maude"]=5
  ["action-plan-artifact.maude"]=4
  ["action-continuation-recovery.maude"]=5
  ["lexical-failure-handler.maude"]=23
  ["action-tell-values.maude"]=9
  ["action-case-types.maude"]=7
  ["action-source-sites.maude"]=6
  ["action-effect-contracts.maude"]=8
  ["action-provider-egress.maude"]=7
  ["action-executor-influence.maude"]=11
  ["action-resource-identity.maude"]=10
  ["action-effect-payload.maude"]=6
  ["action-indexed-values.maude"]=8
  ["action-null-refinement.maude"]=11
  ["action-case-patterns.maude"]=10
  ["action-rule-roots.maude"]=5
  ["action-program-analysis.maude"]=10
  ["action-table-elaboration.maude"]=9
  ["composition-body-context.maude"]=5
  ["managed-fact-provenance.maude"]=6
  ["managed-claim-endorsement.maude"]=4
  ["managed-input-selectors.maude"]=4
  ["managed-field-clearance.maude"]=5
  ["managed-rule-dependencies.maude"]=5
  ["serialized-log-append.maude"]=3
  ["managed-authority-ceilings.maude"]=5
  ["managed-source-flows.maude"]=5
  ["action-value-flow.maude"]=12
  ["action-workflow-terminals.maude"]=7
  ["executable-program.maude"]=6
  ["typed-executable-program.maude"]=15
  ["coerce-settlement.maude"]=5
)
